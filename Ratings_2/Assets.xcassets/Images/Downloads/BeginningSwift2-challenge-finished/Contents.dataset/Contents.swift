...
*/
var restaurantVisit = (restaurantName, totalBill, tipPercentage, totalPaid)
...
*/
let restaurantInfo = (name: "Wing Warehouse", address: "402 Bongo Road", city: "Kalamazoo", rating: 4)
/*:
